> **本译文仅为方便阅读而提供。** 参考版本为[英文版最终用户许可协议](../en/eula.md)和[英文版隐私政策](../en/privacy-policy.md)。若您所在国家的强制性消费者保护法赋予您本国语言版本优先效力，则以该版本为准。本文并非法律建议 — 请咨询您所在司法管辖区的合格律师。
...
Organize Files **在设备本地**处理文件。文件内容**不会上传到发布者自己的服务器**以进行正常的组织或修复操作。应用程序**确实在设备上写入本地文件**（会话快照、恢复状态、可选日志），如下所述。
...
- 组织/修复运行的文件内容  
- 联系人、位置、麦克风或摄像头（未使用）  
- 分析或广告数据（应用中未捆绑此类 SDK）  
- 您在本地保存的 SMTP 密码（除非您通过自己的 SMTP 服务器发送邮件，否则它们保留在您的设备上）
...
- **Microsoft Store / Google Play / Mac App Store** — 计费和权利。Google Play 在设备上验证购买。
...
- [EULA（英文）](../en/eula.md)
- [隐私政策（英文）](../en/privacy-policy.md)
- [隐私政策（德文）](../de/privacy-policy.md)
- [隐私政策（法文）](../fr/privacy-policy.md)
