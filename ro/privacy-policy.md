...
- Date de analiză sau publicitate (aplicația nu include niciun SDK de acest fel)  
...
|----------|--------------|------------|
| Verificare actualizări opțională | GET HTTPS către un manifest de versiune. Gazda (de exemplu GitHub) primește adresa IP a cererii, User-Agent `OrganizeFiles-UpdateCheck/1.0` și metadate TLS. Nu se trimit căi de fișiere sau conținut de fișiere. Dezactivare: `ORGANIZE_FILES_DISABLE_UPDATE_CHECK=1`. | Gazda care servește manifestul JSON |
...
- **Microsoft Store / Google Play / Mac App Store** — facturare și drepturi de utilizare. Google Play validează achizițiile pe dispozitiv.  
...
- [Politica de confidențialitate (germană)](../de/privacy-policy.md)  
- [Politica de confidențialitate (franceză)](../fr/privacy-policy.md)
