...
| Volitelný soubor s průběhem běhu, JSON | `_OrganizeMediaLogs` ve výstupní složce | Počítadla průběhu pro jiné programy |
...
- Analytická nebo reklamní data (žádná taková sada SDK není součástí aplikace)  
- Hesla SMTP, která ukládáte lokálně (zůstávají ve vašem zařízení, dokud neodešlete poštu přes svůj server SMTP)
...
| Místní soubory relace, pokračování a průběhu | Stejný, nutné k poskytování nástroje |
...
- **Microsoft Store / Google Play / Mac App Store** – fakturace a nárok. Google Play ověřuje nákupy v zařízení.
...
- [EULA (anglicky)](../en/eula.md)  
- [Zásady ochrany osobních údajů (rumunština)](../ro/privacy-policy.md)  
- [Zásady ochrany osobních údajů (němčina)](../de/privacy-policy.md)  
- [Zásady ochrany osobních údajů (francouzština)](../fr/privacy-policy.md)
