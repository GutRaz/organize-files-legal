> **편의를 위해 제공된 번역입니다.** 기준 버전은 [영어 EULA](./EULA_EN.md) 및 [영어 개인정보처리방침](./PRIVACY_POLICY_EN.md)입니다. 거주 국가의 강행적 소비자보호법이 사용자의 언어로 된 버전을 우선한다면 그 버전이 적용됩니다. 법적 조언이 아닙니다 — 해당 관할권의 자격 있는 변호사와 상담하십시오.
...
- [EULA (영어)](./EULA_EN.md)
- [개인 정보 보호 정책 (영어)](./PRIVACY_POLICY_EN.md)
- [개인 정보 보호 정책 (독일어)](./PRIVACY_POLICY_DE.md)
- [개인 정보 보호 정책 (프랑스어)](./PRIVACY_POLICY_FR.md)
