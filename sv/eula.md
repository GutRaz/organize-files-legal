> **Översättning tillhandahålls för bekvämlighets skull.** Referensversionerna är [den engelska EULA](../en/eula.md) och [den engelska integritetspolicyn](../en/privacy-policy.md). Där tvingande konsumenträtt i ditt land ger företräde åt versionen på ditt eget språk gäller den versionen. Inte juridisk rådgivning — kontakta en kvalificerad jurist i din jurisdiktion.
...
Appen kan **flytta eller ta bort filer** i varje körning där Testkörning är av. **Du** är ansvarig för verifierade säkerhetskopior innan någon körning.
...
I DEN MAXIMALA UTSTRÄCKNING SOM LAGEN TILLÅTER SKA UTGIVAREN INTE VARA ANSVARIG FÖR NÅGRA INDIREKTA, OAVSIKTLIGA ELLER SÄRSKILDA SKADOR, FÖLJDSKADOR ELLER STRAFFSKADOR, ELLER FÖR FÖRLUST AV DATA, UTEBLIVEN VINST ELLER AVBROTT I VERKSAMHETEN, SOM UPPSTÅR GENOM ANVÄNDNING ELLER MISSBRUK AV PROGRAMVARAN, förutom där tvingande konsumenträtt förbjuder det.
