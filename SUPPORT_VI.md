...
- Phiên bản ứng dụng. Trợ lý hướng dẫn trong ứng dụng hiển thị phiên bản khi được hỏi.
...
- Trước khi một lần chạy từ cửa sổ chính di chuyển hoặc xóa tệp, ứng dụng sẽ yêu cầu xác nhận. **Chạy thử** cho thấy điều gì sẽ xảy ra mà không thay đổi tệp nào.
