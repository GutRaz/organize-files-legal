...
- Analytics or advertising data (no such SDK is bundled in the app)  
...
- **Microsoft Store / Google Play / Mac App Store** — billing and entitlement. Google Play validates purchases on the device.
...
- [EULA (English)](./eula.md)  
- [Privacy policy (Romanian)](../ro/privacy-policy.md)  
- [Privacy policy (German)](../de/privacy-policy.md)  
- [Privacy policy (French)](../fr/privacy-policy.md)
