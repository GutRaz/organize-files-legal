...
Organize Files verwerk lêers **plaaslik op die toestel**. Lêerinhoud word **nie na die uitgewer se eie bedieners opgelaai nie** vir normale organisering of herstelbewerkings. Die toepassing **skryf wel plaaslike lêers** op die toestel (sessiefoto's, hervattoestand, opsionele logs) soos hieronder beskryf.
...
| Opsionele vorderingslêer van 'n lopie, JSON | `_OrganizeMediaLogs` in die uitvoergids | Vorderingstellers vir ander programme |
...
- Analitiese of advertensiedata (geen sodanige SDK is by die program ingesluit nie)  
- SMTP-wagwoorde wat u plaaslik stoor (dit bly op u toestel tensy u pos deur u SMTP-bediener stuur)  
...
| Plaaslike sessie-, hervat- en vorderingslêers | Dieselfde, nodig om die hulpmiddel te verskaf |
...
- **Microsoft Store / Google Play / Mac App Store** — fakturering en reg. Google Play valideer aankope op die toestel.
...
- [EULA (Engels)](../en/eula.md)  
- [Privaatheidsbeleid (Roemeens)](../ro/privacy-policy.md)  
- [Privaatheidsbeleid (Duits)](../de/privacy-policy.md)  
- [Privaatheidsbeleid (Frans)](../fr/privacy-policy.md)
