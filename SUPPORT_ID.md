> **Versi bahasa Indonesia.** Jika terjadi konflik, versi [bahasa Inggris](./SUPPORT.md) yang berlaku.

---

# Dukungan — Organize Files

Butuh bantuan dengan **Organize Files**? Kami dengan senang hati membantu.
...
- Sistem operasi Anda (Windows, Linux, macOS, Android, atau iOS) dan versinya
- Versi aplikasi. Asisten panduan di aplikasi menampilkannya saat ditanya tentang versi.
...
- Sebelum proses dari jendela utama memindahkan atau menghapus file, aplikasi meminta konfirmasi. **Simulasi** menunjukkan apa yang akan terjadi tanpa mengubah file apa pun.
- Selalu simpan **cadangan yang terverifikasi** sebelum menjalankan tindakan yang memindahkan atau menghapus file.
- Dokumentasi dan asisten di aplikasi menjawab banyak pertanyaan umum secara offline.
