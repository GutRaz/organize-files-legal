...
| Optioneel voortgangsbestand van een run, JSON | `_OrganizeMediaLogs` in de uitvoermap | Voortgangstellers voor andere programma's |
...
- Analyse- of advertentiegegevens (een dergelijke SDK is niet in de app opgenomen)  
- SMTP-wachtwoorden die u lokaal opslaat (deze blijven op uw apparaat tenzij u post verzendt via uw SMTP-server)
...
| Lokale sessie-, hervattings- en voortgangsbestanden | Hetzelfde, nodig om de tool te leveren |
...
- **Microsoft Store / Google Play / Mac App Store** — facturering en rechten. Google Play valideert aankopen op het apparaat.
...
- [Privacybeleid (Roemeens)](../ro/privacy-policy.md)  
- [Privacybeleid (Duits)](../de/privacy-policy.md)  
- [Privacybeleid (Frans)](../fr/privacy-policy.md)
