...
L'application peut **déplacer ou supprimer des fichiers** lorsque l'exécution réelle est activée et que les options destructives sont confirmées. **Vous** devez disposer de sauvegardes vérifiées avant toute exécution réelle.
